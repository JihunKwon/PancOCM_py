...
t0 = np.zeros([600,5,np.size(rep_list)])
t1 = np.zeros([600,5,np.size(rep_list)])
t2 = np.zeros([600,5,np.size(rep_list)])
t3 = np.zeros([600,5,np.size(rep_list)])
